                ...
                if(g != null) {
                    ...
                    if(tc != null) {
                        tc.retrieveMessageById(wm.getMessageID()).queue(message -> {
                            ...
                            eb.setDescription(original.getDescription());
                            ...
                            eb.setFooter(Objects.requireNonNull(Objects.requireNonNull(original.getFooter()).getText()).substring(0, 36));
            ...
            if (ac.getTanks().containsValue(l)) {
                ...
                for (long id :
                    ...
                    if (ac.getTanks().get(id) == l) {
                        ...
                        tanks.append("`")
                                .append(String.format("%03d", userData.getGearScore() == null ? 0 : userData.getGearScore()))
                                .append("`")
